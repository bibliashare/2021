...
%-----------------------------------------------------------------------------------------------
            ...
            \item<1-> \YEL{Perder} / \YEL{Perda}:
                \begin{itemize}
                    ...
                    \item \YEL{da força}:
                        \BRI{\textbf{APF, TNMES}}.
                \end{itemize}
            \item<2-> \YEL{Se [...] for} (\BRI{\bf ARC}) / \YEL{Se tornar} (\BRI{\bf AEC}):
                \begin{itemize}
                    \item \YEL{insípido}:
    ...
    \begin{frame}{\BRI{Como lhe \textit{restaurar o sabor\/}? -- Outras Versões}}
        \begin{itemize}
            \item<1-> \YEL{Como} / \YEL{É possível} (\BRI{\bf NVT}):
            ...
            \item<2-> \YEL{Com que}
                ...
                \end{itemize}
            \item<3-> \YEL{Em que}
                $\therefore$ recurso imersivo para o sal
                \begin{itemize}
                    \item \YEL{será salgado}:
                        \BRI{\textbf{IWCL}};
                \end{itemize}
            \item<4-> \YEL{Com o que} / \YEL{outra coisa} (esp.~\BRI{\bf APF})
                $\therefore$ recurso substituvo ao sal
                \begin{itemize}
                    \item \YEL{salgar} / \YEL{temperar}:
                        \BRI{\textbf{ACC, ACF, AEC, AECR, AP, ARC, BKJ, CNBB, FL, HDD, POV, SBU,
                            VOZ}};
                \end{itemize}
            \item<5-> \YEL{Deixa de ser sal}:
                \BRI{\textbf{NTLH}}
                $\therefore$ desvio!!
            \item<5-> \ORA{Como [...] pessoas [...] sentir o tempero}:
                \BRI{\textbf{MESS}}
                $\therefore$ desvio!!
        \end{itemize}
    \end{frame}
