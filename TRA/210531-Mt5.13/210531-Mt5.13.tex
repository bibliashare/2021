...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Mt 5.13 (ARA)}
        \QUOTE{%
            %-----!j 92 -i12
            \ver{13}~
            \alt<1,2>{Vós}{\YEL{Vós}} sois o
            \alt<1,2>{sal da terra}{\GRE{sal da terra}}; ora, se o
            \alt<1,3>{sal}{\CYA{sal}} vier a ser
            \alt<1,4>{insípido}{\RED{insípido}},
            \alt<1,5>{como lhe restaurar o sabor}{\MAG{como lhe restaurar o sabor}}?
            Para nada mais
            \alt<1,6>{presta}{\ORA{presta}} senão para,
            \alt<1,7>{lançado fora}{\RED{lançado fora}}, ser
            \alt<1,8>{pisado}{\ORA{pisado}} pelos homens.
        }
    \end{frame}
